...
\subsection{8. Kafka Streams and Hadoop Comparison
...
The remaining known gaps are: speculative backup tasks, a second MapReduce stage 
for multi-pass jobs and large-scale empirical evidence beyond 64 nodes.
